...
\title{Study on electro-optic noise in crystalline coatings toward future gravitational wave detectors}% Force line breaks with \\
%\thanks{A footnote to the article title}%

\author{Satoshi Tanioka}
 %\altaffiliation[Also at ]{Physics Department, XYZ University.}%Lines break automatically or can be forced with \\
  \email{stanioka@syr.edu}
...
\affiliation{
 Thorlabs Crystalline Solutions, 114 East Haley Street, Suite G, Santa Barbara, California 93101, USA
}%
...
\author{Steven D. Penn}
 %\homepage{http://www.Second.institution.edu/~Charlie.Author}
\affiliation{
 Department of Physics, Hobart William Smith Colleges, 300 Pulteney Street, Geneva, New York 14456, USA
}%
...
\begin{figure}[htbp]
\includegraphics[width=8.6cm]{coating.png}
\caption{
...
\begin{figure}[htbp]
\includegraphics[width=8.6cm]{setup.png}
\caption{
...
\begin{figure}[htbp]
\includegraphics[width=8.6cm]{axis_mod.png}
\caption{
...
\begin{figure}[htbp]
\includegraphics[width=8.6cm]{cavityscan_split_freq.png}
\caption{
...
\begin{figure}[htbp]
\includegraphics[width=8.6cm]{scheme.png}
...
\begin{figure}[htbp]
\includegraphics[width=8.6cm]{results_0825_TF.eps}
\caption{
...
\begin{figure}[htbp]
\includegraphics[width=8.6cm]{cavityscan_fit.eps}
\caption{
...
\begin{figure}[htbp]
\includegraphics[width=8.6cm]{results_0825_PSfit.eps}
\caption{
...
%As the mechanical couplings from the mirror mount and resonances of mirror itself disturb the cavity length below $\sim10{\unit{kHz}}$ and around $\sim50 - 80\unit{kHz}$, we focused on the frequency region $20-40\unit{kHz}$ where the impacts of mechanical couplings can be considered small.
...
%We focus on the frequency region $20-40\unit{kHz}$ where the impacts of mechanical couplings can be considered small and the differential has flat response, and assume that the EO effect in AlGaAs coatings is frequency independent below $40\unit{kHz}$.
...
%Focusing on the frequency region $20-40\unit{kHz}$ and assuming the EO effect is flat response in audio frequency, we obtain {\color{red}$2|C_{\mathrm{EO}}|= 2.2\times10^{-17}\unit{m/(V/m)}$ by fitting the result.
...
The perturbation of the reflected field phase induced by $k$-th coating layer can be described as \cite{Evans2008, Ballmer2015}
\begin{align}
...
\begin{figure}[htbp]
\includegraphics[width=8.6cm]{axis_mirror.png}
\caption{
...
%\section{Parameters of gravitational wave detector}
...
It is important to note that the observed birefringence in crystalline coatings is an “extrinsic” effect, as 100-oriented GaAs is optically symmetric. The current conjecture is that non-uniform strain relaxation, upon cooling from the growth temperature (ref. Bueckle InGaP paper) drives the symmetry breaking. The coatings are grown at high temperature (~600 C) leaving a compressive residual stress of ~100 MPa after cooling. It is possible to tailor the strain by alloying the multilayer with In or P (e.g. GaAsP, InGaP, InGaAs, etc.) but careful measurement of the impact of these materials on the optomechanical properties of the structure would be necessary [Cole APL 2014]. The observed birefringence values (from cavity mode splitting) are all within a similar range, being operating temperature and substrate independent). Furthermore, thermal cycling does not seem to affect the mode splitting for cryogenic coatings. Further study of this effect is needed, including both its static and dynamic (fluctuating) dependence on temperature and optical power. A close collaboration with the optical time-and-frequency metrology field will be useful for rapid “tabletop”-scale investigations of cryogenic effects.  
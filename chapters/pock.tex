...
\noindent For assured simulation convergence, an exponential falloff was applied to the simulation boundaries other than the $\mathrm{r} = 0$ edge:
...
\begin{figure}[!ht]
    ...
    \end{subcaptiongroup}
    \caption{Assembly 3: \subref{subfig:A3disassembled} disassembled configuration and \subref{subfig:A3isometric} an isometric view of the assembled configuration. The electrodes initially used were made of copper; a material chosen its high density with the intention of combatting intertial influence at high frequency, though aluminum plates with near identical geometry were used for later results.}
    \label{fig:assembly3}
\end{figure}

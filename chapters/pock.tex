...
The computed $E_z$ screened by the coating at $r = 0$ for $V = 1$ is estimated to be 33 $[\mathrm{V}/\mathrm{m}]$ and will be included in the calibration as a pockels cell field conversion factor $42 [(\mathrm{V} / \mathrm{m}) / \mathrm{V}]$  

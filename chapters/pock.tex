...
\textbf{current $\mathrm{SiO_2}/\mathrm{TiO_2:Ta_2O_5}$ elasticity params, power spectra, and strain spectral density (order of magnitude estimate)} \cite{harry}
 \\
...
\end{itemize}
\item Frequency Stabilization servo (modified MIT FSS (DCC#D980536)) (LTspice model in appendix)
\end{itemize}

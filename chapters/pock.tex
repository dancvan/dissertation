...
\subsection{Internal friction in Materials and Loss angle}
...
\subsection{Thermal noise of HR mirror coatings}
...
\section{Electro-optic noise of crystalline HR mirror coatings}
...
\noindent For a z-wavevector $E_{[100]} = E_{[010]} = 0$ and $E_{[001]} \neq 0$, computing the eigenvalues and eigenpolarizations help us compute the coorelated eigenindices:
...
\noindent The fast and slow indices ($n_{[110]}$, $n_{[-110]}$) are therefore:

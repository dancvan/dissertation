...
\begin{figure}[H]
\centering
\includegraphics[width=.65\textwidth]{figs/ALGAAS/laplace_coord_test.png}
...
With the the above servo electronics transfer functions, we \href{sec:calibration_math}{calibrate} the measurement into a differential length:
\begin{equation}
...
\caption{Placeholder for more updated MACOR assembly (this figure will end up in appendix to reference parts)}
\label{fig:Ez}
\end{figure}

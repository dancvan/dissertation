...
The computed $E_z$ screened by the coating at $r = 0$ for $V = 1$ is estimated to be 13 $[\mathrm{V}/\mathrm{m}]$ and will be included in the calibration as a pockels cell conversion efficiency of 13 $[(\mathrm{V} / \mathrm{m}) / \mathrm{V}]$  

\begin{figure}[H]
    \includegraphics[width=\textwidth]{ALGAAS/fieldxsec_sim.pdf}
    \caption{Plot of the $| \mathrm{E}_\mathrm{z} |$ field crosc section sampled about the optic HR coating surface.}
\label{fig:Ez}
\end{figure}

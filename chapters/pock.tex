...
\noindent \textcolor{green}{Unpublished estimate with $E = 13.3 [\mathrm{V} / \mathrm{m}] / [V]$}
\begin{equation}
    h_\mathrm{EO\; noise} = 2\frac{\Delta L_\mathrm{EO \; noise}}{L} = 2\frac{\partial L}{\partial E} \times \bigg| \frac{E_\mathrm{noise}}{L_\mathrm{arm}} \bigg| = 5.715 \times 10^{-26} \; [1/ \sqrt{\mathrm{Hz}}]
\end{equation}


\noindent \textcolor{green}{Published estimate with $E = 42 [\mathrm{V}/\mathrm{m}]/ [V] $ }
\begin{equation}
    h_\mathrm{EO\; noise} = 2\frac{\Delta L_\mathrm{EO \; noise}}{L} = 2\frac{\partial L}{\partial E} \times \bigg| \frac{E_\mathrm{noise}}{L_\mathrm{arm}} \bigg| = 1.6 \times 10^{-26} \; [1/ \sqrt{\mathrm{Hz}}]
\end{equation}

...
$$
\noindent The differential reflectivity is normalized by the total reflectivity and taking the imaginary component as indicated in \ref{eq:partial_M}: 
...
\noindent The impact of a differential electric noise field ($E$) on $M$ due to the electro-optic effect on the kth layer, we use the chain rule:

\begin{equation}
	\bigg| \frac{\partial \phi_c}{\partial  E} \bigg| =  \bigg| \frac{\partial \phi_c}{\partial \phi_k}  \frac{\partial \phi_k}{\partial E} \bigg|
\end{equation}
...
\begin{equation}
	\bigg| \frac{\partial \phi_c}{\partial  E} \bigg|  = 3.9 \times 10^{-11}\; [\mathrm{rad}/\mathrm{V}/\mathrm{m}]      
\end{equation}

...
\begin{equation}
	\mathdefault{H_FPMI} = \frac{t_1 ^2 r_2}{(t_1^2 + r_1^2)r_2 - r_1} \frac{\mathdefault{H_MICH}}{1 - r_1 r_2 e^{-2i \omega L / c}}
\end{equation}
...
\begin{equation}
	\mathdefault{G_{PR}} = \frac{\pi}{2 \matchscr{F} \mathscr{L}_\mathdefault{RT}} \bigg[ \frac{1}{1- \frac{ \matchscr{F} \mathscr{L}_\mathdefault{RT}}{ 2 \pi}} \bigg]
\end{equation}
...
\begin{equation}
\mathrm{H}_\mathrm{DRFPMI} = \mathrm{G}_\mathrm{PR} \mathrm{P}_\mathrm{in} L \Omega \bigg[ \frac{ t_1^2 r_2}{(t_1^2 + r_1^2)r_2 - r_1} \frac{t_\mathrm{SRM} t_1}{1-r_1 r_\mathrm{SRM}} \frac{e^{-i 2 \pi L f / c} \mathrm{sin}( 2 \pi f / c)}{ 2 \pi L f } \frac{1}{(1- r_1 r_\mathrm{SRM}) e^{-i 4 \pi L f / c}} \bigg]
\end{equation}

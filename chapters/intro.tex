...
\begin{equation}
	\mathrm{G_{PR}} = \frac{\pi}{2 \matchscr{F} \mathscr{L}_\mathrm{RT}} \bigg[ \frac{1}{1- \frac{ \matchscr{F} \mathscr{L}_\mathrm{RT}}{ 2 \pi}} \bigg]
\end{equation}

...
The connection between fluctuations on a microscopic level and their contributions to macroscopic observables allows one to bypass having to venture into the involved microscopic processes; a profound finding for experiments that are or will become thermal noise limited. Though the FDT by no means is a modification of our understanding of the equipartition theorem but rather enriches our understanding of the microscopic phenomenon when measuring power spectral density.         

...
\section{High Voltage Amplifier (HVA) transfer functions [V$_\mathrm{out}$ / V$_\mathrm{in}$]}
...
\section{FSS transfer function (compared with LTSPICE)}
...
\hline
$r_\mathrm{ap}$ &  $t_\mathrm{cap}$ & $r_\mathrm{d}$ & $t_\mathrm{el}$ & $r_\mathrm{opt}$ & $t_\mathrm{opt} $\\
\hline

...
\begin{figure}[H]
    \centering
\includegraphics[width=.75\textwidth]{figs/TCS/self_heating_zpk.pdf}
...
\begin{figure}[H]
    \centering
\includegraphics[width=.75\textwidth]{figs/TCS/CO2_zpk.pdf}
\caption{Fitted zpk filter to transient CO2 actuation response.}
\label{fig:co2_zpk_fit}
\end{figure}

\newpage
\section{Thermo-optic Path Distortion}
...
\newpage
\section{EO Modulation (Application)}\label{appendix:EOM}
...
\newpage
\section{Laplacian in Cylindrical coordinates (Numerical Recipe)}\label{appendix:numerical_recipe}

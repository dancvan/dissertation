...
\end{figure}
\section{Analytical transient thermo-optic responses (Pt.2)}

\subsection{Thermo-optic Path Distortion (analytical)}
\subsubsection{Thermorefractive aberration}
...
\subsubsection{Thermoelastic aberration}

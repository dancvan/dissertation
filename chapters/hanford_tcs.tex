...
\textcolor{red}{Figure of DARM noise during O3a. Beneficial features of interferometry, i.e. common mode noise rejection require adequate mode overlap at the beam splitter. Destruction of such symmetry as mode overlap proportionally destroys such benefits and demonstrate a presence in DARM} \cite{buikema:2020}

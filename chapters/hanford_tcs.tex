...
\begin{figure}[H]
    ...
    \caption{A DARM noise budget during O3a~\cite{elog:2018:dwyer}. Beneficial features of interferometry, i.e. common mode noise rejection requires adequate mode overlap at the beam splitter. Destruction of such symmetry as mode overlap proportionally destroys such benefits and demonstrate a presence in DARM. Here in this noise budget both Frequency and Intensity noise are about 2 times above the anticipated noise level. \swb{Re[place "both Frequency and Intensity noise are about 2 times above the anticipated noise level." with "Frequency noise (at high frequencies) and Intensity noise (at low frequencies) are about 2 times above the design noise level."]}}  

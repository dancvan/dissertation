...
The transient in the RH power resembles that of a step, which naturally lends itself to invertingthis response function which can provide a reasonable first order filter correction. Therefore, the prescription for creating such a filter is realized through inversion of the known RH step response alongside additional low passing at high frequency to avoid any high frequency control instabilities \footnote{see appendix for more detail}.
...
One of the beneficial features of interferometry is common mode noise filtering (i.e. laser intensity and frequency noise). Though these benefits are contingent upon the ability to preserve arm symmetry. Intentional asymmetries like the Schnupp asymmetry, a macroscopic differential length offset introduced in order to pass optical sidebands for normal interferometer functionality and stability, is well known and designed to keep common mode noise low. Meanwhile, common arm cancellation can is exacerbated proportionally with the amount of mode mismatch.

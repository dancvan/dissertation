...
\\ 
There must also be considerations when we cannot assume the scaling of this function is not linear and time-invariant (i.e. concurrent RH changes). With enough modeling, independent measurements spanning an actuation space, and techniques like Kalman Filtering, there is room to develop a more robust Dynamic Thermal Compensation strategy.

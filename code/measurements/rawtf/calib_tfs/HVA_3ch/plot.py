...
#3chHVAmag_10to100.TXT
#3chHVAphase_10to100.TXT
#SCRN0494.TXT
#SCRN0495.TXT

magmeas1 = np.loadtxt('3chHVAmag_10to100.TXT').transpose()
phmeas1 =  np.loadtxt('3chHVAphase_10to100.TXT').transpose()
magmeas2 = np.loadtxt('SCRN0494.TXT').transpose()
phmeas2 =  np.loadtxt('SCRN0495.TXT').transpose()
...
bode_plt(meastr1, save_path='.', lbl='hvach3_10to100k')
bode_plt(meastr2, save_path='.', lbl='hvach3')
